...
const About = ({ aboutData, setNumber }) => {
    const { _id, title, description, keywords } = aboutData;
        ...
        <>
            <section className="my-2 boxShadow bg-gray rounded me-3 p-3">
                <div className="d-flex justify-content-center">
                    <h1 className="fs-24 spacing-3">About Page</h1>
                </div>
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">
                                Meta Tag and description For About
                            </h5>
                            <button
                                type="button"
                                className="btn-close"
